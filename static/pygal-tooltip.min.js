		...
		(c = function(c) {
				...
				(m = G[z]),
					...
					m.addEventListener(
						...
						(function(b) {
							return function() {
								var d, e, f, g, h, i, j, k;
								for (i = a('.serie-' + b + ' .reactive', c), e = 0, g = i.length; g > e; e++)
									(d = i[e]), d.classList.add('active');
								for (j = a('.serie-' + b + ' .showable', c), k = [], f = 0, h = j.length; h > f; f++)
									(d = j[f]), k.push(d.classList.add('shown'));
								return k;
							};
						})(p)
					),
					m.addEventListener(
						...
						(function(b) {
							return function() {
								var d, e, f, g, h, i, j, k;
								for (i = a('.serie-' + b + ' .reactive', c), e = 0, g = i.length; g > e; e++)
									(d = i[e]), d.classList.remove('active');
								for (j = a('.serie-' + b + ' .showable', c), k = [], f = 0, h = j.length; h > f; f++)
									(d = j[f]), k.push(d.classList.remove('shown'));
								return k;
							};
						})(p)
					),
					m.addEventListener(
						...
						(function(b, d) {
							return function() {
								...
								for (n = a('.text-overlay .serie-' + d, c), o = [], j = 0, l = n.length; l > j; j++)
									(e = n[j]), o.push((e.style.display = h ? '' : 'none'));
								return o;
							};
						})(m, p)
					);
			...
			return (
				...
				(r = function(c) {
					...
					for (
						l.tooltip_fancy_mode &&
							(u.push([ O, 'xlink' ]), u.unshift([ N, 'x_label' ]), u.unshift([ y, 'legend' ])),
							H = {},
							W = 0,
							U = u.length;
						U > W;
						...
						(Z = u[W]),
							...
							s &&
								...
								(e = f),
								void 0 !== F.style.dominantBaseline
									? (F.style.dominantBaseline = 'text-before-edge')
									: (e += 0.8 * F.getBBox().height),
								F.setAttribute('y', e),
								(H[z] = F));
					return (
